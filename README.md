An old transformer based typescript framework. Has a unique networking design schema to allow for you to write serialized data to a buffer stream, this version was pre-buffer support on ROBLOX.
